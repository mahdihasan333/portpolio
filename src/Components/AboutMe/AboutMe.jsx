...
const AboutMe = () => {
    return (
        <div className="text-white">
            <div>
                <h2>About Me</h2>
                <h6>Hi! I'm Mahdi Hassan, a passionate and dedicated web developer who loves creating beautiful and functional websites. My journey into programming started out of curiosity, which has now turned into a full-blown passion. I began with frontend development, mastering technologies like React, and now I'm learning backend development to become a full-stack developer in the future.
                    ...
                    I'm always eager to learn new things, improve my skills, and connect with people passionate about technology and innovation. Let's create something amazing together!</h6>
            </div>
        </div>
    );
};
